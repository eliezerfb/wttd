...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_body(self):
        ...
        self.assertIn('Eliézer Bourchardt', email.body)
        self.assertIn('12345678910', email.body)
        self.assertIn('eliezerfb@gmail.com', email.body)
        self.assertIn('49-98402-0730', email.body)
...
class SubscribeSuccessMessage(TestCase):
    def test_message(self):
        data = dict(name='Eliézer Bourchardt', cpf='12345678901',
                    email='eliezerfb@gmail.com', phone='49-98402-0730')

        response = self.client.post('/inscricao/', data, follow=True)
        self.assertContains(response, 'Inscriçao realizada com sucesso!')
